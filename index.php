...
if(isset($_GET['page'])){
	...
	switch ($page){	
		...
		case "shop":
			...
			$tpl['paginaScripts']                   = getScriptElements(array("js/vendor/jquery/DataTables-1.10.11/media/js/jquery.dataTables.min.js", "js/shop.js"));
			$tpl['paginaStylesheets']               = getLinkElements("js/vendor/jquery/DataTables-1.10.11/media/css/jquery.dataTables.css");
                        break;
		...
		case "registreer":
			...
			$tpl['paginaScripts']                   = getScriptElements(array("js/vendor/jquery/jquery-validatie-x.x.x/dist/jquery.validate.min.js","js/registreer.js"));
			break;		
